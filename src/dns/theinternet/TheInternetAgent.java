...
public class TheInternetAgent extends Agent {
	...
	// Visto che è l'unico Behaviour ed è di modeste dimensioni, lo includo nell'agente stesso
	private class TheInternetAgent_CreateNewHost extends TickerBehaviour {
